...
const Detail = () => {
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=+5521971218692&text=Tenho interesse sobre coleta de resíduos`);
    // Linking.openURL(`whatsapp://send?phone=+5521${data.point.whatsapp}&text=Tenho interesse sobre coleta de resíduos`);
  }
